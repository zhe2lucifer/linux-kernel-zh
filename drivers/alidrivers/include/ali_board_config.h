...
#define LOGSM_SEE2MAIN_BUF_SIZE    0X40
#endif
...
extern unsigned long __G_ALI_MM_FB2_SEE_START_ADDR;
...
#ifdef CONFIG_LOGSM_SEE2MAIN
extern unsigned long __G_ALI_MM_LOGSM_SEE2MAIN_START_ADDR;
extern unsigned long __G_ALI_MM_LOGSM_SEE2MAIN_SIZE;
#endif
...
extern unsigned long __G_ALI_MM_INIT_RAMFS_SIZE;
extern unsigned long __G_ALI_MM_INIT_RAMFS_ADDR;
...
// nand flash gpio & pinmux
extern long g_nand_wp_gpio;

extern long g_enet_speed_gpio;
extern long g_enet_link_gpio;
extern long g_enet_gpio_light;

/* gpio i2c */
extern unsigned int g_gpio_i2c_hdmi_id;
extern unsigned int g_gpio_i2c_hdmi_sda;
extern unsigned int g_gpio_i2c_hdmi_scl;
...
#endif
/* smc */
extern unsigned int g_smc_invert_detect;
...
unsigned long __G_ALI_MM_VIDEO_PIP_SIZE = 0;
unsigned long __G_ALI_MM_VIDEO_PIP_START_ADDR = 0;
...
unsigned long __G_ALI_MM_VDEC_VBV_START_ADDR = 0;

unsigned long __G_ALI_MM_VDEC_PIP_VBV_SIZE = 0;
unsigned long __G_ALI_MM_VDEC_PIP_VBV_START_ADDR = 0;

unsigned long __G_ALI_MM_VDEC_HW_BUF_SIZE = 0;
unsigned long __G_ALI_MM_VDEC_HW_BUF_START_ADDR = 0;

unsigned long __G_ALI_MM_VDEC_PIP_HW_BUF_SIZE = 0;
unsigned long __G_ALI_MM_VDEC_PIP_HW_BUF_START_ADDR = 0;
...
unsigned long __G_ALI_MM_FB2_SEE_START_ADDR = 0;
...
unsigned long __G_ALI_MM_DMX_PIP_MEM_SIZE = 0;
unsigned long __G_ALI_MM_DMX_PIP_MEM_START_ADDR = 0;
...
//for tac
unsigned long __G_ALI_MM_TAC_MEM_SIZE = 0;
unsigned long __G_ALI_MM_TAC_MEM_START_ADDR = 0;


unsigned long __G_ALI_MM_APE_PIP_MEM_SIZE = 0;
unsigned long __G_ALI_MM_APE_PIP_MEM_START_ADDR = 0;

unsigned long __G_ALI_MM_PVR_BUF_MEM_SIZE = 0;
unsigned long __G_ALI_MM_PVR_BUF_MEM_START_ADDR = 0;
...
#ifdef CONFIG_LOGSM_SEE2MAIN
unsigned long __G_ALI_MM_LOGSM_SEE2MAIN_START_ADDR = 0;
unsigned long __G_ALI_MM_LOGSM_SEE2MAIN_SIZE = 0;
#endif
...
unsigned long __G_ALI_MM_NIM_PARAM_BUF_SIZE = 0;
unsigned long __G_ALI_MM_NIM_PARAM_BUF_ADDR = 0;

unsigned long __G_ALI_MM_INIT_RAMFS_SIZE = 0;
unsigned long __G_ALI_MM_INIT_RAMFS_ADDR = 0;
...
EXPORT_SYMBOL(g_usb_p0_host_5v_gpio);
/* GPIO definition end */
...
long g_nand_wp_gpio = 0;

long g_enet_speed_gpio = 103;
long g_enet_link_gpio = 102;
long g_enet_gpio_light = 0;

/* gpio i2c */
unsigned int g_gpio_i2c_hdmi_id = 0xffffffff;
unsigned int g_gpio_i2c_hdmi_sda = GPIO_PORT_MAX + 1;
unsigned int g_gpio_i2c_hdmi_scl = GPIO_PORT_MAX + 1;
...
/* volbar */
#ifdef CONFIG_ALI_VOLBAR
unsigned int g_gpio_vol_up;
unsigned int g_gpio_vol_down;
#endif

/* smc */
unsigned int g_smc_invert_detect = 0;
