...
#define MEM_ALLOC_UNIT (128*1024) //!< DSC memory unit.
 ...
 *   @brief Specify the algorithm and its device pointer for live play or playback.
*/
struct dec_parse_param
{  
	void *dec_dev;   //!< The device pointer of the specified algorithm.
...
typedef struct ali_dsc_krec_mem
{
	...
	void *va_mem;//!< For users to store the corresponding user space address.
} ALI_DSC_KREC_MEM;
