...
#define CH454_DEV_NAME				"pan_ch454"
#define CH454_DEV_INPUT_NAME		CH454_DEV_NAME
...
#define ALI_FP_GET_KUMSGQ	    					(ALI_FP_IO_COMMAND_BASE+14)
...
#define PAN_ALI_HKEY_POWER        0xffff0000
#define PAN_ALI_HKEY_UPGRADE    0xffff0018
