...
#define PM_CMD_SET_STR_CMAC_PROTECTION_SIZE  _IOW('o', 503, unsigned int)    /* set the STR cmac protection size */
#define PM_CMD_CALC_STR_CMAC  _IOW('o', 504, unsigned int)    /* calc the cmac of the STR cmac protection zone */
