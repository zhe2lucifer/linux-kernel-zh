...
#define ALI_SOC_REBOOT_GET_TIMER   _IOR('S', 33, struct reboot_timer)	//!< Not used any more.
#define ALI_SOC_ENTER_STANDBY      _IOW('S', 34 , struct boot_timer)	//!< Not used any more.
...
#define ALI_SOC_REBOOT   	_IO('S', 51)								//!< Not used any more.
#define ALI_DSC_ACC_CE_DIS   _IO('S', 52)								//!< Not used any more.
...
#define ALI_SOC_FLASH_MAP   _IO('S', 65)								//!< Get flash map for Hardware security.
#define ALI_SOC_GET_BOOT_MODE _IO('S', 66)      						//! < Get Strapping BootMode
#define ALI_SOC_READ_WRITE_REG _IOW('S', 67, struct soc_read_write_reg) //! < Read or Write Reg by user
#define ALI_SOC_READ_PHY_MEM _IOW('S', 68,struct soc_opt_paras32)
#define ALI_SOC_WRITE_PHY_MEM _IOW('S', 69, struct soc_opt_paras32)
#define ALI_SOC_COLD_REBOOT _IO('S', 70)
