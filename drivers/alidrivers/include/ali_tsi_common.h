...
#define ALI_TSI_INPUT_SET _IOW(ALI_TSI_IOC_MAGIC, 41, struct ali_tsi_input_set_param)			//!< Setting TSI input parameter.
#define ALI_TSI_CHANNEL_SET _IOW(ALI_TSI_IOC_MAGIC, 42, struct ali_tsi_channel_set_param)		//!< Setting TSI channel parameter.
#define ALI_TSI_OUTPUT_SET _IOW(ALI_TSI_IOC_MAGIC, 43, struct ali_tsi_output_set_param)			//!< Setting TSI output parameter.
#define ALI_TSI_CI_LINK_MODE_SET _IOW(ALI_TSI_IOC_MAGIC, 44, enum ali_tsi_ci_link_mode)			//!< Setting CI link mode.
#define ALI_TSI_CI_BYPASS_SET _IOW(ALI_TSI_IOC_MAGIC, 45, struct ali_tsi_ci_bypass_set_param)	//!<Setting CI bypass parameter.
#define ALI_TSI_CI_SPI_0_1_SWAP _IOW(ALI_TSI_IOC_MAGIC, 46, __s32)								//!< Setting CI SPI 0 and SPI 1 swap.The setting is global
