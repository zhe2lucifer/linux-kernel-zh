...
#define IO_VBI_CHECK_TTX_TASK_START  					(VBI_IO + 14) 
#define IO_VBI_SET_VPO_HD_SD_PARAM						(VBI_IO + 15)
#define IO_VBI_SET_SOURCE_TYPE							(VBI_IO + 16)
#define IO_VBI_SET_CC_TYPE								(VBI_IO + 17)
#define IO_VBI_GET_CC_TYPE								(VBI_IO + 18)
#define IO_VBI_TTX_STOP									(VBI_IO + 19)
