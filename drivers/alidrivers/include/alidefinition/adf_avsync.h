...
#define AVSYNC_IO_SET_VDEC_ID                   0x11    //!< Set which vdec to do avsync
#define AVSYNC_IO_PIP_SWITCH                    0x12
#define AVSYNC_IO_SET_DMX_ID                    0x13
#define AVSYNC_IO_CHECK_CUTAUDIO                0x14  //!< Check cut audio for video master
#define AVSYNC_IO_GET_SYNC_MODE                 0x15    //!< Get sync mode
#define AVSYNC_IO_GET_DMX_ID                    0x16
...
/*!
@enum AVSYNC_PTS_STATUS
@brief  Current PTS is change or not.
*/
typedef enum
{
	AVSYNC_PTS_NORMAL,       //!< PTS change
	AVSYNC_PTS_UNCHANGE,        //!< PTS UNchange
}AVSYNC_PTS_STATUS;
...
typedef struct
{
	...
	UINT8 inter_sync;                    //!< Avsync inter sync mode.
	UINT8 rsvd1;                         //!< Reserved.
	UINT32 cur_vpts;                     //!< Current video PTS.
	UINT32 cur_apts;                     //!< Current audio PTS.
	UINT32 ts_vpts;                      //!< VPTS from TS.     
	UINT32 ts_apts;                      //!< APTS from TS.
}avsync_status_t;
...
struct avsync_pip_param_t
{
    UINT8 vdec_id;
    UINT8 live_play;
    AVSYNC_MODE_E sync_mode;
    AVSYNC_SRCTYPE_E src_type;
    UINT32 unit;
    UINT8 dmx_id;
};

#define AVSYNC_CB_MAX_DEV_NUM    6      //!< Maximum AVSYNC device numbers.
...
typedef RET_CODE (*AVSYNC_PROCESS_PCR_CB)(struct avsync_device *, UINT32, UINT32);
