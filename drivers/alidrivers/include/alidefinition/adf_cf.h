 ...
 * Ioctl definitions
 */
#define ALI_CF_IO_VERSION_INFO       0
#define ALI_CF_IO_FEATURE_VECTOR      1
#define ALI_CF_IO_CF_STATUS           2
#define ALI_CF_IO_TRANS_STATUS        3
#define ALI_CF_IO_DECM_STATUS        4
#define ALI_CF_IO_ISSUE_OP_FEATURE     5
#define ALI_CF_IO_ISSUE_OP_DIFF      6
#define ALI_CF_IO_ISSUE_OP_CWCORSHV    7
#define ALI_CF_IO_READ_OP_RESULT     9
#define ALI_CF_IO_WAIT_OP_DONE     10
