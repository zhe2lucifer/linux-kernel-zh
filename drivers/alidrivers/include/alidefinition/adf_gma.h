...
#define MAX_GMA_REGION_WIDTH	4096
#define MAX_GMA_REGION_HEIGHT	4096
...
typedef struct gma_dmem_pars_t
{
    ...
    UINT32 hw_buf_start[MAX_GMA_NUM];
    UINT32 hw_buf_size[MAX_GMA_NUM];
}GMA_DMEM_PARS;
...
int gma_attach_m36f(int layer_num, UINT32 mem_base, UINT32 mem_size);
