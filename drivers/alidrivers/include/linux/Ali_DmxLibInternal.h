...
/* HW DMX Linux output interface dev name, used by kernel.
*/
...
/* SW DMX Linux output interface dev name, used by kernel.
*/
...
/* SW DMX Linux input interface dev name, used by kernel.
*/
...
/* HW DMX Linux output interface dev path, used by user space.
*/
...
/* SW DMX Linux output interface dev name, used by user space.
*/
...
/* SW DMX Linux input interface dev name, used by user space.
*/
...
/* DMX HW interface ID, data source from tuner, used by kernel.
*/
...
/* DMX HW interface ID, data source from user space, used by kernel.
*/
#define ALI_SWDMX0_OUTPUT_HWIF_ID 4
#define ALI_SWDMX1_OUTPUT_HWIF_ID 5

/* DMX HW interface ID, data source from SEE, used by kernel.
*/
...
struct Ali_DmxDrvTsStrmStatInfo
{
	...
	__u32 WrByteErrCnt;		//!< Count of stream writing error
	__u32 RdByteErrCnt;		//!< Count of stream reading error
	__u32 CopyErrCnt;		//!< Count of errors in copying stream parameters
	__u32 CloseFailCnt;		//!<Count of stream closing error
	__u32 CfgFailCnt;		//!< Count of stream configuration error
	__u32 StartFailCnt;		//!< Count of stream starting error
	__u32 StopFailCnt;		//!< Count of stream stopping error
...
{
	__u32 TsInCnt;			//!< Count of TS package
	__u32 ByteInCnt;		//!< Not used any more.
...
struct Ali_DmxDrvTsFltStatInfo
{
    ...
    __u32 TsSyncByteErrCnt;	//!< Count of TS package synchronization error
...
struct Ali_DmxSeeGlobalStatInfo
{
	...
	__u32 TsDecryFailCnt;	//!< Count of decrypt failure
...
struct Ali_DmxSeePlyChStatInfo 
{
	...
	__u32 PesTsErrCnt;			//!< Count of error TS package in PES parsing
	__u32 PesTsScrmbCnt;		//!< Count of scrambled Ts package in PES parsing
    __u32 PesTsDupCnt;			//!< Count of duplicated Ts package in PES parsing
    __u32 PesTsLostCnt;			//!< Count of lost TS package in PES parsing
    __u32 PesHdrLenErrCnt;		//!< Count of PES header length too short error
...
@brief Demux statistics info in SEE CPU.Must keep compatible with TDS struct Ali_DmxSeeStatistics.
*/
struct Ali_DmxSeeStatistics
{
