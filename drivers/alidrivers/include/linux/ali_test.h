...
#define ALI_TEST_IP_BW_CONFIG  		_IO(ALI_TEST_IOC_MAGIC, 15)//_IOWR(ALI_TEST_IOC_MAGIC, 15 , struct test_ip_bw_cfg_info)
	
#define ALI_TEST_IP_BW_GET  		_IO(ALI_TEST_IOC_MAGIC, 16)//_IOWR(ALI_TEST_IOC_MAGIC, 16 , struct test_ip_get_bw)

#define ALI_TEST_IP_BW_STATUS  		_IO(ALI_TEST_IOC_MAGIC, 17)

#define ALI_TEST_IP_INT  			_IO(ALI_TEST_IOC_MAGIC, 18)

#define ALI_TEST_CHECK_L2_CACHE  			_IO(ALI_TEST_IOC_MAGIC, 19)
