...
#define VIRT_CACHE_PATCH_READ_CH1          (VIRT_NOR_FLASH - SIZE_CACHE_PATCH) 
#define VIRT_CACHE_PATCH_READ_CH2          (VIRT_CACHE_PATCH_READ_CH1 - SIZE_CACHE_PATCH) 
...
#define ALI_IRQ_VOLBAR_GPIO (ALI_SYS_IRQ_BASE + 0)
#endif

// CI  Controller
#define ALI_CI_REG_BASE 0x1801a000
#define ALI_CI_REG_LENGTH 0x4900
#define ALI_IRQ_CI (ALI_SYS_IRQ_BASE + 9)
