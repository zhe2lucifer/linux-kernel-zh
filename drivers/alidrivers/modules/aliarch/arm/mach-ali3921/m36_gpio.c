...
EXPORT_SYMBOL(gpio_disable_pin);
...
EXPORT_SYMBOL(enable_gpio_interrupt_pin);		
...
EXPORT_SYMBOL(disable_gpio_interrupt_pin);
...
EXPORT_SYMBOL(set_gpio_rising_ir_pin);
...
EXPORT_SYMBOL(set_gpio_falling_ir_pin);
...
EXPORT_SYMBOL(clear_gpio_interrupt_status);
...
EXPORT_SYMBOL(clear_gpio_point_isr);
...
EXPORT_SYMBOL(get_gpio_interrupt_status);
...
EXPORT_SYMBOL(ali_gpio_direction_output);
...
EXPORT_SYMBOL(gpio_irq_disable);
