...
#define SCU_CPU_STATES_REG                           (unsigned long *)(A9_MPCORE_SCU + 0x08)
#define SCU_CONTROL_REG                                (unsigned long *)(A9_MPCORE_SCU + 0x00)
#define SCU_INVALIDATE_ALL_REG                     (unsigned long *)(A9_MPCORE_SCU + 0x0C)
#define SCU_EN                                                 0x1/*Enable the SCU.*/
//=========================================================================================//

/*This is called from headsmp.S to wakeup the secondary core.*/
extern void my_secondary_startup(void);
extern unsigned long secondary_starup_phys_addr;

/*control for which core is the next to come out of the secondary boot "holding pen".*/
...
#endif
{
	...
	secondary_cpu_boot_addr = virt_to_phys(my_secondary_startup);
	printk("platform_smp_prepare_cpus:%x %x,scureg:0x%x, 0x18000054_V:0x%x\n", my_secondary_startup, \
		secondary_cpu_boot_addr, *(volatile unsigned int*)A9_MPCORE_SCU, __REGALIRAW(0x18000054));
	...
	secondary_starup_phys_addr = secondary_cpu_boot_addr;
