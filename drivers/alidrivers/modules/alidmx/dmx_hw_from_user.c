...
{  
	...
	if(of_property_read_u32(pdev_dt->dev.of_node, "sw_dmx_data_buf_size", &hw_dev->buf_size))
		hw_dev->buf_size = DMX_HW_FROM_USER_BUF_LEN;

    data_buf = vmalloc(hw_dev->buf_size);
