...
__s32 dmx_hw_pid_exclude_mode_set
(
    __u32 interface_id,
...
)
{
    ...
    if (NULL == interface->hw_pid_exclude_mode_set)
    {
        return(DMX_ERR_HW_NO_FUNCTION);
    }   

    ret = interface->hw_pid_exclude_mode_set(interface->hw_dev_id, pid_exclude_mode);
...
)
{
    ...
    if (hw_dev_type == DMX_HW_INTERFACE_TYPE_HW)
    {
         ...
         * chip_ID == ALI_S3701C
         */
        else if ((ALI_C3921 == chip_id) || (ALI_S3503 == chip_id) || (ALI_S3821 == chip_id) || (ALI_C3505 == chip_id))
        {
            //printk("%s,%d\n", __FUNCTION__, __LINE__);
...
)
{
    ...
    if (hw_dev_type == DMX_HW_INTERFACE_TYPE_HW)
    {
        ...
        else if ((ALI_C3921 == chip_id) || (ALI_S3503 == chip_id) || (ALI_S3821 == chip_id) || (ALI_C3505 == chip_id))
        {
            ...
            ret = dmx_hw_resume_m37(hw_dev_id, interface);
...
)
{
    ...
    if (hw_dev_type == DMX_HW_INTERFACE_TYPE_HW)
    {
        ...
        else if ((ALI_C3921 == chip_id) || (ALI_S3503 == chip_id) || (ALI_S3821 == chip_id) || (ALI_C3505 == chip_id))
        {
            ...
            ret = dmx_hw_deinit_m37(hw_dev_id, interface);
