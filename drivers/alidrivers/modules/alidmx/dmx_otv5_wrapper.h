...
/**@file
 *
 *  @file               dmx_otv5_wrapper.h
 *  @brief              Create this file because the redefine symbol "get_dev_by_name"
 *
 *  @version            1.0
 *  @date               09/23/2014 02:10:20 PM
 *  @revision           none
 *
 *  @author             Stephen Xiao <stephen.xiao@alitech.com>
 */

#ifndef _DMX_OTV5_WRAPPER_H_
#define _DMX_OTV5_WRAPPER_H_
