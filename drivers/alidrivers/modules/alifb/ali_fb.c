...
module_param(g_fb_dbg_flag, ulong, S_IRUSR | S_IWUSR | S_IRGRP | S_IROTH);
MODULE_PARM_DESC(g_fb_dbg_flag, "ali fb debug flag");
...
{
    UINT8 *backup_pic_y_top_buffer;
    UINT8 *backup_pic_c_top_buffer;
    UINT8 *backup_pic_y_bottom_buffer;
    UINT8 *backup_pic_c_bottom_buffer;
...
static unsigned int GetSupportListDSUB(void)
{
	...
	if (edid_data[0x12] == 0x1 /*&& \
		...
		Addr
		/Offset
				Value Stored (in hex) = (Horizontal addressable pixels ?? 8) ?V 31
...
Address  2 Bytes	Value 					Description
				01h ?? FFh	If byte 16h ?? 00h then byte 15h = Horizontal Screen Size in cm.
  ...
  15h	1		01h ?? FFh	If byte 16h = 00h then byte 15h = Aspect Ratio (Landscape)
				...
				01h ?? FFh	If byte 15h ?? 00h then byte 16h = Vertical Screen Size in cm.
							(Range is 1 cm ?? 255 cm)
  ...
  16h						ratio are unknown or undefined.
	...
	Given the Aspect Ratio, the Stored Value may be calculated by using the following equation:
						Stored Value = (Aspect Ratio ?? 100) ?V 99
	...
	Given the Aspect Ratio, the Stored Value may be calculated by using the following equation:
						Stored Value = (100 ?? Aspect Ratio) ?V 99
...
*/
		...
		*/
		...
		/* Timings I: EDID addr offset 23h
			?? Supported Established Timings II include
		 	?? 720x400@70Hz,
			?? 720x400@88Hz,
		 	?? 640x480@60Hz,
			?? 640x480@67Hz,
...
static int init_stadard_gma_region(struct fb_info *fbinfo)
{
	...
	gma_info->scale_mode = GMA_RSZ_ALPHA_COLOR;
...
static int ali_ge_set_cmdq(struct alifbio_cmdq_buf *ge_cmdq)
{
    ...
    if (ge_cmdq->cmdq_index == 0)
    {
    	...
    	ret = copy_from_user((void *)pos, (void *)ge_cmdq->cmdq_buf, ge_cmdq->cmdq_size);
		__CACHE_FLUSH_ALI((unsigned long)pos, ge_cmdq->cmdq_size);
...
static int osd_is_run(int layer_id)
{
    ...
    if((ali_sys_ic_get_chip_id() == ALI_C3921) || (ali_sys_ic_get_chip_id() == ALI_S3821) || (ali_sys_ic_get_chip_id() == ALI_C3505))
    {
...
static int alifb_hld_ioctl(unsigned int cmd, unsigned long arg)
{
    ...
    switch(cmd)
    {
        case VPO_SET_WIN_ONOFF:
        {
			...
			ret = copy_from_user((void *)&win_status_pars, (void *)arg, sizeof(win_status_pars));
		...
		case VPO_SET_WIN_MODE:
        {
			...
			ret = copy_from_user((void *)&win_mode_pars, (void *)arg, sizeof(win_mode_pars));
		...
		case VPO_WIN_ZOOM:
        {
			...
			ret = copy_from_user((void *)&zoom_pars, (void *)arg, sizeof(zoom_pars));
		...
		case VPO_SET_ASPECT_MODE:
        {
			...
			ret = copy_from_user((void *)&aspect_par, (void *)arg, sizeof(aspect_par));
		...
		case VPO_SET_TVSYS:
        {
			...
			ret = copy_from_user((void *)&tvsys_pars, (void *)arg, sizeof(tvsys_pars));
		...
		case VPO_CONFIG_SOURCE_WINDOW:
        {
			...
			ret = copy_from_user((void *)&win_config_pars, (void *)arg, sizeof(win_config_pars));
        ...
        case VPO_SET_BG_COLOR:
        {
            ...
            ret = copy_from_user((void *)&bg_color_pars, (void *)arg, sizeof(bg_color_pars));
        ...
        case VPO_REG_DAC:
        {
            ...
            ret = copy_from_user((void *)&dac_pars, (void *)arg, sizeof(dac_pars));
        ...
        case VPO_SET_PARAMETER:
        {
            ...
            ret = copy_from_user((void *)&parameter_pars, (void *)arg, sizeof(parameter_pars));
        ...
        case VPO_VIDEO_ENHANCE:
        {
            ...
            ret = copy_from_user((void *)&video_enhance_pars, (void *)arg, sizeof(video_enhance_pars));
        ...
        case VPO_SET_CGMS_INFO:
        {
            ...
            ret = copy_from_user((void *)&cgms_info_pars, (void *)arg, sizeof(cgms_info_pars));
        ...
        case VPO_AFD_CONFIG:
        {
            ...
            ret = copy_from_user((void *)&afd_pars, (void *)arg, sizeof(afd_pars));
        ...
        case VPO_GET_CURRENT_DISPLAY_INFO:
        {
            ...
            ret = copy_from_user((void *)&display_info_pars, (void *)arg, sizeof(display_info_pars));
		...
		case VPO_GET_DAC_INFO:
		{
			struct ali_vpo_dac_state_pars dac_state_pars;

            ret = copy_from_user((void *)&dac_state_pars, (void *)arg, sizeof(dac_state_pars));
            cur_dev = dac_state_pars.hd_dev == 0 ? g_sd_vpo_dev : g_vpo_dev;
			ret = vpo_ioctl(cur_dev, VPO_IO_GET_DAC_INFO, (uint32)(&dac_state_pars.dac_state));

            ret = copy_to_user((void __user *)arg, &dac_state_pars, sizeof(dac_state_pars));
            break;
		}
		case VPO_GET_CGMS_INFO:
		{
            struct ali_vpo_ioctrl_pars ioctrl_pars;

            ret = copy_from_user((void *)&ioctrl_pars, (void *)arg, sizeof(ioctrl_pars));
            cur_dev = ioctrl_pars.hd_dev == 0 ? g_sd_vpo_dev : g_vpo_dev;
			ret = vpo_ioctl(cur_dev, VPO_IO_GET_CGMS_INFO, (UINT32)&ioctrl_pars.param);
        ...
        case VPO_GET_MP_INFO:
        {
            ...
            ret = copy_from_user((void *)&mp_info_pars, (void *)arg, sizeof(mp_info_pars));
        ...
        case VPO_SET_OSD_SHOW_TIME:
        {
            ...
            ret = copy_from_user((void *)&osd_show_time_pars, (void *)arg, sizeof(osd_show_time_pars));
        ...
        case VPO_GET_MP_SCREEN_RECT:
        {
            ...
            ret = copy_from_user((void *)&screem_rect_pars, (void *)arg, sizeof(screem_rect_pars));
        ...
        case VPO_GET_MP_SOURCE_RECT:
        {
            struct ali_vpo_screem_rect_pars screem_rect_pars;

            ret = copy_from_user((void *)&screem_rect_pars, (void *)arg, sizeof(screem_rect_pars));
            cur_dev = screem_rect_pars.hd_dev == 0 ? g_sd_vpo_dev : g_vpo_dev;
			ret = vpo_ioctl(cur_dev, VPO_IO_GET_MP_SOURCE_RECT, (uint32)(&screem_rect_pars.mp_screem_rect));
        ...
        case VPO_GET_REAL_DISPLAY_MODE:
        {
            ...
            ret = copy_from_user((void *)&ioctrl_pars, (void *)arg, sizeof(ioctrl_pars));
            cur_dev = ioctrl_pars.hd_dev == 0 ? g_sd_vpo_dev : g_vpo_dev;
			ret = vpo_ioctl(cur_dev, VPO_IO_GET_REAL_DISPLAY_MODE, (UINT32)&ioctrl_pars.param);
		...
		case VPO_GET_TV_ASPECT:
        {
            ...
            ret = copy_from_user((void *)&ioctrl_pars, (void *)arg, sizeof(ioctrl_pars));
            cur_dev = ioctrl_pars.hd_dev == 0 ? g_sd_vpo_dev : g_vpo_dev;
			ret = vpo_ioctl(cur_dev, VPO_IO_GET_TV_ASPECT, (UINT32)&ioctrl_pars.param);
		...
		case VPO_GET_SRC_ASPECT:
        {
            ...
            ret = copy_from_user((void *)&ioctrl_pars, (void *)arg, sizeof(ioctrl_pars));
            cur_dev = ioctrl_pars.hd_dev == 0 ? g_sd_vpo_dev : g_vpo_dev;
			ret = vpo_ioctl(cur_dev, VPO_IO_GET_SRC_ASPECT, (UINT32)&ioctrl_pars.param);
        ...
        case VPO_GET_DISPLAY_MODE:
        {
            ...
            ret = copy_from_user((void *)&ioctrl_pars, (void *)arg, sizeof(ioctrl_pars));
            cur_dev = ioctrl_pars.hd_dev == 0 ? g_sd_vpo_dev : g_vpo_dev;
			ret = vpo_ioctl(cur_dev, VPO_IO_GET_DISPLAY_MODE, (UINT32)&ioctrl_pars.param);
        ...
        case VPO_GET_OUT_MODE:
        {
            ...
            ret = copy_from_user((void *)&ioctrl_pars, (void *)arg, sizeof(ioctrl_pars));
            cur_dev = ioctrl_pars.hd_dev == 0 ? g_sd_vpo_dev : g_vpo_dev;
			ret = vpo_ioctl(cur_dev, VPO_IO_GET_OUT_MODE, (UINT32)&ioctrl_pars.param);

            ret = copy_to_user((void __user *)arg, &ioctrl_pars, sizeof(ioctrl_pars));
            break;
        }
		case VPO_CGMS_STATUS_GET:
        {
            struct ali_vpo_ioctrl_pars ioctrl_pars;

            ret  = copy_from_user((void *)&ioctrl_pars, (void *)arg, sizeof(ioctrl_pars));
            cur_dev = ioctrl_pars.hd_dev == 0 ? g_sd_vpo_dev : g_vpo_dev;
            ret = vpo_ioctl(cur_dev, VPO_IO_CGMS_STATUS_GET, (UINT32)&ioctrl_pars.param);
        ...
        case VPO_GET_OSD0_SHOW_TIME:
        {
            ...
            ret = copy_from_user((void *)&ioctrl_pars, (void *)arg, sizeof(ioctrl_pars));
            cur_dev = ioctrl_pars.hd_dev == 0 ? g_sd_vpo_dev : g_vpo_dev;
			ret = vpo_ioctl(cur_dev, VPO_IO_GET_OSD0_SHOW_TIME, (UINT32)&ioctrl_pars.param);
        ...
        case VPO_GET_OSD1_SHOW_TIME:
        {
            ...
            ret = copy_from_user((void *)&ioctrl_pars, (void *)arg, sizeof(ioctrl_pars));
            cur_dev = ioctrl_pars.hd_dev == 0 ? g_sd_vpo_dev : g_vpo_dev;
			ret = vpo_ioctl(cur_dev, VPO_IO_GET_OSD1_SHOW_TIME, (UINT32)&ioctrl_pars.param);
        ...
        case VPO_GET_VBI_TTX_ISR:
        {
            struct ali_vpo_vbittx_info_pars vbittx_info_pars;

            ret = copy_from_user((void *)&vbittx_info_pars, (void *)arg, sizeof(vbittx_info_pars));
            cur_dev = vbittx_info_pars.hd_dev == 0 ? g_sd_vpo_dev : g_vpo_dev;
            cur_dev = g_vpo_dev;
			ret = vpo_ioctl(cur_dev, VPO_IO_GET_VBI_TTX_ISR, (UINT32)(&vbittx_info_pars.param));

            ret = copy_to_user((void __user *)arg, &vbittx_info_pars, sizeof(vbittx_info_pars));

            break;
        }
        case VPO_WRITE_TTX_PACKET:
        {
            struct ali_vpo_vbittx_packet_pars vbittx_packet_pars;

            ret = copy_from_user((void *)&vbittx_packet_pars, (void *)arg, sizeof(vbittx_packet_pars));
            cur_dev = vbittx_packet_pars.hd_dev == 0 ? g_sd_vpo_dev : g_vpo_dev;
			ret = vpo_ioctl(cur_dev, VPO_IO_WRITE_TTX_PACKET, (UINT32)(&vbittx_packet_pars.param));
            break;
        }
        case VPO_SET_VBI_STARTLINE:
        {
            struct ali_vpo_ioctrl_pars ioctrl_pars;
            ret = copy_from_user((void *)&ioctrl_pars, (void *)arg, sizeof(ioctrl_pars));
            cur_dev = ioctrl_pars.hd_dev == 0 ? g_sd_vpo_dev : g_vpo_dev;

            ret = vpo_ioctl(cur_dev, VPO_IO_WRITE_TTX_PACKET, (uint32)(ioctrl_pars.param));
        }
		case VPO_WRITE_WSS:
        {
            struct ali_vpo_ioctrl_pars ioctrl_pars;
        ...
        case VPO_ENABLE_VDAC_PLUG_DETECT:
        {
            struct ali_vpo_ioctrl_pars ioctrl_pars;

            ret = copy_from_user((void *)&ioctrl_pars, (void *)arg, sizeof(ioctrl_pars));
            cur_dev = ioctrl_pars.hd_dev == 0 ? g_sd_vpo_dev : g_vpo_dev;
			ret = vpo_ioctl(cur_dev, VPO_IO_ENABLE_VDAC_PLUG_DETECT, (uint32)(ioctrl_pars.param));
            break;
        }
        case VPO_IO_GET_BOOT_LOGO_STATUS:
		case VPO_GET_BOOT_LOGO_STATUS:
        {
            struct ali_vpo_ioctrl_pars ioctrl_pars;

            ret = copy_from_user((void *)&ioctrl_pars, (void *)arg, sizeof(ioctrl_pars));
            cur_dev = ioctrl_pars.hd_dev == 0 ? g_sd_vpo_dev : g_vpo_dev;
			ret = vpo_ioctl(cur_dev, VPO_IO_GET_BOOT_LOGO_STATUS, (uint32)&ioctrl_pars.param);
            ret = copy_to_user((void __user *)arg, &ioctrl_pars, sizeof(ioctrl_pars));
            break;
        }
        case VPO_DISPLAY_3D_ENABLE:
        {
            struct ali_vpo_ioctrl_pars ioctrl_pars;
            ...
            ret = vpo_ioctl(cur_dev, VPO_IO_DISPLAY_3D_ENABLE, (uint32)(ioctrl_pars.param));
            break;
        }
        case VPO_ENABLE_ANTIFLICK:
        {
            struct ali_vpo_ioctrl_pars ioctrl_pars;
            ...
            ret = vpo_ioctl(cur_dev, VPO_IO_ENABLE_ANTIFLICK, (uint32)(ioctrl_pars.param));
            break;
        }
        case VPO_SET_ANTIFLICK_THR:
        {
            struct ali_vpo_ioctrl_pars ioctrl_pars;
            ...
            ret = vpo_ioctl(cur_dev, VPO_IO_SET_ANTIFLICK_THR, (uint32)(ioctrl_pars.param));
            break;
        }
        case VPO_EXCHANGE_VIDEO_LAYER:
        {
            struct ali_vpo_ioctrl_pars ioctrl_pars;
            ...
            ret = vpo_ioctl(cur_dev, VPO_IO_EXCHANGE_VIDEO_LAYER, (uint32)(ioctrl_pars.param));
            break;
        }
        case VPO_CLOSE_DEO:
        {
            ...
            ret = vpo_ioctl(cur_dev, VPO_IO_CLOSE_DEO, (uint32)(ioctrl_pars.param));
            break;
        }
        case VPO_SET_CUTOFF:
        {
            struct ali_vpo_cutoff_pars cutoff_par;
            ret = copy_from_user((void *)&cutoff_par, (void *)arg, sizeof(cutoff_par));
            cur_dev = cutoff_par.hd_dev == 0 ? g_sd_vpo_dev : g_vpo_dev;

            ret = vpo_ioctl(cur_dev, VPO_IO_SET_CUTOFF, (uint32)(&cutoff_par.param));
            break;
        }
		case VPO_SELECT_SCALE_MODE:
        {
            struct ali_vpo_ioctrl_pars ioctrl_pars;

            ret = copy_from_user((void *)&ioctrl_pars, (void *)arg, sizeof(ioctrl_pars));
            cur_dev = ioctrl_pars.hd_dev == 0 ? g_sd_vpo_dev : g_vpo_dev;
			ret = vpo_ioctl(cur_dev, VPO_IO_SELECT_SCALE_MODE, (uint32)(ioctrl_pars.param));
            break;
		}
        default:
            break;
...
static int alifb_backup_picture(struct ali_vpo_display_info_pars *display_info_pars)
{
    ...
    ret = vpo_ioctl(cur_dev, VPO_IO_BACKUP_CURRENT_PICTURE, (UINT32)dis_info);
...
static int alifb_free_backup_picture(void)
{
    ...
    vpo_ioctl(cur_dev, VPO_IO_FREE_BACKUP_PICTURE, (UINT32)0);
			...
			unsigned long arg)
{
	...
	switch(cmd){
		...
		{
			ret = copy_to_user((void *)arg, (void *)&fbinfo, sizeof(fbinfo));
			break;
		}
		case FBIO_GET_FBINFO_DATA:
		{
			...
			ret = copy_to_user((void *)arg, (void *)&fbinfo_pars, sizeof(fbinfo_pars));
			break;
		}
        ...
        case FBIO_SET_PREMULTIPLY:
        {
        		...
        		gma_get_region_info(gma_dev, 0, &pars);
                pars.premultiply_sel = arg;
        		gma_set_region_info(gma_dev, 0, &pars);
            #endif
            break;
        }
        case FBIO_WIN_ZOOM:
		{
			...
			ret = copy_from_user((void *)&zoom, (void *)arg, sizeof(zoom));
		...
		case FBIO_WIN_ONOFF:
		{
			...
			else if(info->DE_layer >= DE_LAYER2)
			{
				...
				FB_PRF("open/close osd layer %ld\n", arg);
            }
			else
            {
				ret = -EINVAL;
        ...
        case FBIO_GMA_SCALE:
		{
			...
			ret = copy_from_user((void *)&scale_pars, (void *)arg, sizeof(scale_pars));
			...
			for(i = 0;i < VIDEO_MAX_GMA_REGION_NUM;i++) {
				...
				if(gma_info->valid) {
                    ...
                    gma_info->scale_mode = GMA_RSZ_ALPHA_COLOR;
                    #endif
                    gma_info->x_off = scale_pars.x_off;
                    gma_info->y_off = scale_pars.y_off;
		...
		case FBIO_SET_PALLETTE:
		{
			...
			ret = copy_from_user((void *)&plt_pars, (void *)arg, sizeof(plt_pars));

			if(plt_pars.color_num == 256){
				ret = copy_from_user(info->palette_buffer, plt_pars.pallette_buf, (plt_pars.color_num * 4));
		...
		case FBIO_GET_PALLETTE:
		{
			...
			ret = copy_from_user(&plt_pars, (void *)arg, sizeof(plt_pars));
			ret = copy_to_user(plt_pars.pallette_buf, info->palette_buffer, info->pallete_size * 4);
			plt_pars.color_num = info->pallete_size;
			plt_pars.level = info->plt_alpha_level;
			ret = copy_to_user((void *)arg, (void *)&plt_pars, sizeof(plt_pars));
		...
		case FBIO_CREATE_GMA_REGION:
		{
			...
			ret = copy_from_user((void *)&reg_par, (void *)arg, sizeof(reg_par));
			...
			if(1){//info->dis_format == reg_par.dis_format){
				if(reg_par.index < VIDEO_MAX_GMA_REGION_NUM
                    ...
                    #endif
					fbinfo->var.vmode &= ~FB_VMODE_YWRAP;
		...
		case FBIO_MOVE_REGION:
		{
			...
			ret = copy_from_user((void *)&pars, (void *)arg, sizeof(pars));
        ...
        case FBIO_GET_DISPLAY_RECT:
        {
            ...
            #else
            ret = ali_gma_ioctl(info, GMA_IO_GET_DISPLAY_RECT, (uint32)&pars);
            #endif
			ret = copy_to_user((void *)arg, (void *)&pars, sizeof(pars));
            FB_PRF("get display rect pos x %d y %d\n",pars.x, pars.y);
            break;
        }
        case FBIO_SET_DISPLAY_RECT:
        {
            struct gma_rect rect_pars;
            ret = copy_from_user((void *)&rect_pars, (void *)arg, sizeof(rect_pars));
            #ifndef CONFIG_RPC_HLD_GMA
            ali_set_GMA_IOCtl(info,(uint32)&rect_pars);
            #else
            ret = ali_gma_ioctl(info, GMA_IO_SET_DISPLAY_RECT, (uint32)&rect_pars);
            #endif
		...
		case FBIO_RPC_OPERATION:
		{
			...
			for(i = 0;i < pars.arg_num;i++){
				...
				if(g_ali_fb_rpc_arg_size[i] > 0){
					...
					ret = copy_from_user((void *)g_ali_fb_rpc_arg[i], pars.arg[i].arg, g_ali_fb_rpc_arg_size[i]);
				}
			}
...
RPC_EXIT:
			for(i = 0;i < pars.arg_num;i++){
				if(g_ali_fb_rpc_arg_size[i] != 0){
					if(pars.arg[i].out)
						ret = copy_to_user(pars.arg[i].arg, (void *)g_ali_fb_rpc_arg[i], g_ali_fb_rpc_arg_size[i]);
				}
			}
		...
		case FBIO_GET_UI_RSC_MAP:
		{
            ...
            ret = copy_to_user((void*)arg, (void*)(&mem_map), sizeof(mem_map));
			break;
		}
        #endif
        #endif
        ...
        case FBIO_SET_GE_CMDQ_BUF:
		{
            struct alifbio_cmdq_buf my_cmdq;
   			ret = copy_from_user((void *)&my_cmdq, (void *)arg, sizeof(my_cmdq));
			ret = ali_ge_set_cmdq(&my_cmdq);
//            FB_PRF("set ge cmdq buf 0x%lx size 0x%x\n", my_cmdq.cmdq_buf, my_cmdq.cmdq_size);
			break;
		}
		...
		case FBIO_SET_UI_CACHE_FLUSH:
		{
			...
			ret = copy_from_user((void *)&cache_flush, (void *)arg, sizeof(cache_flush));
      ...
      //      FB_PRF("UI cache flush addr 0x%x len 0x%x\n", cache_flush.mem_start, cache_flush.mem_size);
        ...
        case FBIO_FLAG_WAIT:
        {
            ...
            {
//                 FB_PRF("wait ge command time out, cmd_bit: 0x%08lx, timeout = %ld\n", cmd_bit, timeout);
        ...
        case FBIO_GET_GE_CMDQ_BUF_ADDR_SIZE:
    		{
                ...
                ge_cmd_buf_info.addr = __G_ALI_MM_GE_CMD_START_ADDR & 0x1FFFFFFF;
                ge_cmd_buf_info.size = __G_ALI_MM_GE_CMD_SIZE;
                ret = copy_to_user((void*)arg, (void*)(&ge_cmd_buf_info), sizeof(ge_cmd_buf_info));
		...
		case FBIO_VIDEO_ENHANCE:
		{
			...
			ret = copy_from_user((void *)&enhance_pars, (void *)arg, sizeof(enhance_pars));
        ...
        {
            ret = ali_gma_wait_for_vsync(info);
            break;
        }
...
static int alifb_check_var(struct fb_var_screeninfo *var, struct fb_info *fbinfo)
{
    ...
    {
		FB_PRF("%s : FB_VMODE_YWRAP: x %d w %d y %d h %d cur virtual %d %d var virtual %d %d\n"
	...
	else if(((var->xoffset + var->xres) > var->xres_virtual) || ((var->yoffset + var->yres) > var->yres_virtual))
	{
    ...
    {
        if((var->xres_virtual * var->yres_virtual * var->bits_per_pixel/8) > (1920*1080))
        {
    		...
    		, var->yoffset, var->xres, var->yres, var->xres_virtual, var->yres_virtual);
            pr_info("out of buffer of fb2!!\n");
            return -1;
        }
	}
	...
	switch(var->bits_per_pixel)
	{
		...
		case 16:
            ...
            var->blue.offset = 0;
            var->blue.length = (var->green.length == 6) ? 5 : var->green.length;
			var->blue.msb_right = 0;
            var->green.offset = var->blue.offset + var->blue.length;
            var->green.msb_right = 0;
            var->red.offset = var->green.offset + var->green.length;
            var->red.length = (var->green.length == 6) ? 5 : var->green.length;
            var->red.msb_right = 0;
            var->transp.offset = (var->red.offset + var->red.length) & 0xF;
            var->transp.length = (var->transp.offset == 0) ? 0 : (16 - var->transp.offset);
            var->transp.msb_right = 0;
            #else
	...
	FB_PRF("%s : line %d fb%d bits %d x %d y %d w %d h %d max_w %d max_h %d  need max buffer:%d\n"
		, __FUNCTION__, __LINE__, fbinfo->node, var->bits_per_pixel, var->xoffset
		, var->yoffset, var->xres, var->yres, var->xres_virtual
		, var->yres_virtual,var->xres_virtual*var->yres_virtual*var->bits_per_pixel/8);
...
static int alifb_set_par(struct fb_info *fbinfo)
{
	...
	else if(var->bits_per_pixel == 16)
	{
		if(var->green.length == 6)
            ...
            info->dis_format = dis_format_to_ge(DIS_FORMAT_ARGB4444);
	}
	else if(var->bits_per_pixel == 32)
	{
...
static int alifb_setcmap(struct fb_cmap *cmap, struct fb_info *fbinfo)
{
	...
	FB_PRF("%s : line %d cmap_len %d cmap_start %d palette_buffer 0x%lx.\n"
		, __FUNCTION__, __LINE__, cmap->len, cmap->start, (UINT32)info->palette_buffer);
...
do_mmap_job:
    ...
    FB_PRF("%s: __G_ALI_MM_FB0_SIZE = %ld __G_ALI_MM_FB2_SIZE = %ld  real max buffer:vma->vm_end-vma->vm_start = %ld\n",
            __func__,__G_ALI_MM_FB0_SIZE, __G_ALI_MM_FB2_SIZE, vma->vm_end - vma->vm_start);
...
void disable_semaphore_irq(struct alifb_info *info)
{
    unsigned int val = 0;
    val = __REG32ALI(info->sema_int_clr_reg);

    /* [5:4] semaphore interrupt clear */
    val |= (0x3<<4);
    __REG32ALI(info->sema_int_clr_reg) = val;
}

static irqreturn_t ali_semaphore_interrupt(int irq, void *dev_id)
{
    struct alifb_info *info = (struct alifb_info *)dev_id;

    spin_lock(&info->slock);
    //printk("/* semaphore interrupt, accept it */!\n");
    if(info->sema_flag)
    {
        info->sema_flag = 0;
    	info->sema_count++;
    	wake_up_interruptible(&info->sema_wait);
    }

    disable_semaphore_irq(info);
    //disable_irq_nosync(info->sema_irq);
    spin_unlock(&info->slock);

    return IRQ_HANDLED;
}

static int set_fbinfo_in_default(struct fb_info *fbinfo, struct platform_device *pdev)
{
	struct alifb_info *info = (struct alifb_info *)fbinfo->par;
    int id = 0;
    int ret = 0;

    __G_ALI_MM_GE_CMD_START_ADDR |= 0xa0000000;
	...
	if(id == 3)
	{
        ...
        fbinfo->fix.smem_len = __G_ALI_MM_FB2_SIZE;
        #ifdef CONFIG_ARM
		fbinfo->fix.smem_start = virt_to_phys((void *)__G_ALI_MM_FB2_START_ADDR);
        #else
	...
	else if(id == 1)
	{
		...
		if(fbinfo->fix.smem_len > __G_ALI_MM_FB0_SIZE){
			fbinfo->var.yres_virtual = fbinfo->var.yres_virtual/2;
			fbinfo->fix.smem_len = fbinfo->fix.line_length * fbinfo->var.yres_virtual;
			printk("smem_len [0x%x] __G_ALI_MM_FB0_SIZE [0x%x]\n",
				(int)fbinfo->fix.smem_len , (int)__G_ALI_MM_FB0_SIZE);
		}

		fbinfo->fix.smem_len = __G_ALI_MM_FB0_SIZE;
        #ifdef CONFIG_ARM
		fbinfo->fix.smem_start = virt_to_phys((void *)__G_ALI_MM_FB0_START_ADDR);
        #else
    ...
    if (id == 1) {
        if (info->support_sema) {
            info->sema_count = 0;
            init_waitqueue_head(&info->sema_wait);
            spin_lock_init(&info->slock);

            info->sema_irq = 79;//platform_get_irq(pdev, 1);
            info->sema_int_clr_reg = 0x18040104;
            if (info->sema_irq < 0) {
                info->support_sema = 0;
        		dev_err(&pdev->dev, "failed to get sema irq resource\n");
            } else {
                FB_PRF("sema irq num %d\n", info->sema_irq);

        		ret = devm_request_irq(&pdev->dev, info->sema_irq, ali_semaphore_interrupt,IRQF_TRIGGER_NONE | IRQF_SHARED,
        		                       dev_name(&pdev->dev), info);
                if (ret) {
                    info->support_sema = 0;
                    dev_err(&pdev->dev, "failed to request sema irq\n");
                } else {
                    //disable_semaphore_irq(info);
                }
            }
...

	{
		...
		if(id == 3)
		{
			info->palette_buffer = (void *)__G_ALI_MM_FB2_CMAP_START_ADDR;
		}
		else if(id == 1)
		{
			info->palette_buffer = (void *)__G_ALI_MM_FB0_CMAP_START_ADDR;
		}
...
static int __init alifb_probe(struct platform_device *pdev)
{
	...
	if(!set_fbinfo_in_default(fbinfo, pdev)) {
...
static int alifb_suspend(struct platform_device *pdev, pm_message_t state)
{
	...
	if(pdev->id == 2)
	{
		vpo_ioctl(g_vpo_dev, VPO_IO_SUSPEND_DE, (uint32)NULL);
		mdelay(60);
		vpo_ioctl(g_sd_vpo_dev, VPO_IO_SUSPEND_DE, (uint32)NULL);
		mdelay(60);
	}
...
static int alifb_resume(struct platform_device *pdev)
{
	...
	if(pdev->id == 1)
	{
		gma_get_region_info(g_gma_dev0, 0, &pars);
		gma_set_region_info(g_gma_dev0, 0, &pars);
		gma_show(g_gma_dev0, 1);
	}
#endif
	...
	if(pdev->id == 2)
	{
		vpo_ioctl(g_vpo_dev, VPO_IO_RESUME_DE, (uint32)NULL);
		mdelay(50);
		vpo_ioctl(g_sd_vpo_dev, VPO_IO_RESUME_DE, (uint32)NULL);
		mdelay(100);
	}
...
static ssize_t alifb_debug_show(struct device_driver *ddp, char *buf)
{
	return snprintf(buf, PAGE_SIZE, "%ld\n", g_fb_dbg_flag);
}

static ssize_t alifb_debug_store(struct device_driver *ddp, const char *buf, size_t count)
{
	int value = (*buf) - '0';
    ...
    switch(value) {
        case 0:
            g_fb_dbg_flag = 0;
            #ifdef CONFIG_RPC_HLD_GMA
            ali_gma_set_dbg_flag(m_fb_info, (unsigned long)value);
            #endif
            printk("disable dbg info\n");
            break;
        case 1:
            g_fb_dbg_flag = 1;
            printk("enable kernel dbg info\n");
            break;
        case 2:
            #ifdef CONFIG_RPC_HLD_GMA
            ali_gma_set_dbg_flag(m_fb_info, (unsigned long)value);
            #endif
            printk("enable see dbg info\n");
            break;
        default:
            break;
    }
...
static DRIVER_ATTR(debug, S_IRUSR | S_IWUSR,
		   alifb_debug_show, alifb_debug_store);

static struct attribute *alifb_drv_attrs[] = {
	&driver_attr_debug.attr,
	NULL
};

static struct attribute_group alifb_attr_grp = {
	.attrs = alifb_drv_attrs
};

static const struct attribute_group *alifb_drv_attr_groups[] = {
	&alifb_attr_grp,
	NULL,
};
