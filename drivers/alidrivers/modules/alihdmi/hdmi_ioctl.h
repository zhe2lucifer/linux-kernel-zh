...
#define HDMI_IOCG_GET_AUDIO_CEA			_IOR(HDMI_IOC_MAGIC, 	71,	SHORT_AUDIO_DESCRIPTOR_t *)
#define HDMI_IOCG_GET_VIDEO_CEA			_IOR(HDMI_IOC_MAGIC, 	72,	SHORT_VIDEO_DESCRIPTOR_t *)
