...
#endif
#define M36F_SYS_REG_PLL_VCXO_0		(*(volatile unsigned char *)(0xB8000606))
#define M36F_SYS_REG_PLL_VCXO_1		(*(volatile unsigned char *)(0xB8000607))
#define M36F_SYS_REG_PLL_VCXO_2		(*(volatile unsigned char *)(0xB8000608))
...
#define HDMI_REG_CEC_BIU_FREQ	        	(*(volatile unsigned int *)(HDMI_REG_BASEADDR + 0x79))
...
#define B_CMU_VOLDET_PD			0x80		// for 3821 new phy  
...
#define B_DP_RSTN					0x01
#define B_VIDEO_MODE				0x02
#define B_HD_SD_SEL				0x04
#define B_RGB_YUV_SEL				0x08
#define B_YUV_CH_SEL				0x70
#define B_RND_EN					0x80

/* offset 0x99 */
#define B_DE_DATA_WIDTH			0x03
#define B_444TO422_EN				0x04
#define B_FX2_RSTN					0x08
#define B_VOU_BUF_ADDR_INI			0x30
#define B_13DOT5_MODE				0x40
#define B_DP_POLARITY				0x80

/* offset 0x9A */
#define B_PP_LINE_7_0				0xFF
