...
#define SYS_I2C1_SDA 13
#define SYS_I2C1_SCL 12
...
static struct
{
	int sda;
	int scl;
} i2c_gpio_reg[I2C_GPIO_NUM] = {{SYS_I2C_SDA, SYS_I2C_SCL}, {SYS_I2C1_SDA, SYS_I2C1_SCL}}; 

#define SET_SDA_OUT(id)	ali_gpio_direction_output(i2c_gpio_reg[id].sda)/*HAL_GPIO_BIT_DIR_SET(i2c_gpio_reg[id].sda, HAL_GPIO_O_DIR)*/
#define SET_SDA_IN(id)	ali_gpio_direction_input(i2c_gpio_reg[id].sda)/*HAL_GPIO_BIT_DIR_SET(i2c_gpio_reg[id].sda, HAL_GPIO_I_DIR)*/
#if( EXTERNAL_PULL_HIGH == TRUE)
#define SET_SDA_HI(id)	SET_SDA_IN(id)
#define SET_SDA_LO(id)	ali_gpio_set_value(i2c_gpio_reg[id].sda, 0)/*SET_SDA_OUT(id);  HAL_GPIO_BIT_SET(i2c_gpio_reg[id].sda, 0)*/
#else
#define SET_SDA_HI(id)	ali_gpio_set_value(i2c_gpio_reg[id].sda, 1)/*HAL_GPIO_BIT_SET(i2c_gpio_reg[id].sda, 1)*/
#define SET_SDA_LO(id)	ali_gpio_set_value(i2c_gpio_reg[id].sda, 0)/*HAL_GPIO_BIT_SET(i2c_gpio_reg[id].sda, 0)*/
#endif
#define GET_SDA(id)		ali_gpio_get_value(i2c_gpio_reg[id].sda)/*HAL_GPIO_BIT_GET(i2c_gpio_reg[id].sda)*/

#define SET_SCL_OUT(id)	ali_gpio_direction_output(i2c_gpio_reg[id].scl)/*HAL_GPIO_BIT_DIR_SET(i2c_gpio_reg[id].scl, HAL_GPIO_O_DIR)*/
#define SET_SCL_IN(id)	ali_gpio_direction_input(i2c_gpio_reg[id].scl)/*HAL_GPIO_BIT_DIR_SET(i2c_gpio_reg[id].scl, HAL_GPIO_I_DIR)*/
#if( EXTERNAL_PULL_HIGH == TRUE)
#define SET_SCL_HI(id)	SET_SCL_IN(id)
#define SET_SCL_LO(id)	ali_gpio_set_value(i2c_gpio_reg[id].scl, 0)/*SET_SCL_OUT(id); HAL_GPIO_BIT_SET(i2c_gpio_reg[id].scl, 0)*/
#else
#define SET_SCL_HI(id)	ali_gpio_set_value(i2c_gpio_reg[id].scl, 1)/*HAL_GPIO_BIT_SET(i2c_gpio_reg[id].scl, 1)*/
#define SET_SCL_LO(id)	ali_gpio_set_value(i2c_gpio_reg[id].scl, 0)/*HAL_GPIO_BIT_SET(i2c_gpio_reg[id].scl, 0)*/
#endif
#define GET_SCL(id)		ali_gpio_get_value(i2c_gpio_reg[id].scl)/*HAL_GPIO_BIT_GET(i2c_gpio_reg[id].scl)*/
