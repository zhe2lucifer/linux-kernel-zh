...
#ifdef ERR_DEBUG
    #define ERR_PRINTF(fmt, args...)  printk("ERR: " fmt, ##args)
#else
	#define ERR_PRINTF(...)
#endif

#ifdef FFT_PRINTF_DEBUG
    #define FFT_PRINTF(fmt, args...)  printk("FFT: " fmt, ##args)
#else
	#define FFT_PRINTF(...)
#endif
...
#ifdef PLSN_DEBUG
    #define PLSN_PRINTF(fmt, args...)  printk("PLSN_PRINTF: " fmt, ##args)
#else
    #define PLSN_PRINTF(...)	
#endif

#ifdef TSN_DEBUG
    #define TSN_PRINTF(fmt, args...)  printk("TSN_PRINTF: " fmt, ##args)
#else
    #define TSN_PRINTF(...)	
#endif
...
struct nim_c3501h_private
{
	...
	/*chanscan_autoscan_flag:
	   *1:channel change or autoscan is working now;
	   0:channel change or autoscan finished*/
...
extern __u32 nim_c3501h_dvbs_as_cb2_ui(void *p_priv, __u8 lck, __u8 polar, __u16 freq, __u32 sym, __u8 fec, __u8 as_stat);                               
...
INT32 nim_c3501h_wide_band_scan_close(void);
...
extern const UINT8 c3501h_map_beta_normal_adaptive_en[32];
extern const UINT8 c3501h_map_beta_short_adaptive_en[32];
extern const UINT16 c3501h_map_beta_normal_snr_thres[32][2];
