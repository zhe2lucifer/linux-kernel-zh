...
static void nim_s3501_print_work_mode(UINT8 work_mode)
{
    ...
    case 0 :
    {
        S3501_PRINTF(NIM_LOG_DBG,"            work_mode is DVB-S \n");
        break;
    }
    case 1 :
    {
        S3501_PRINTF(NIM_LOG_DBG,"            work_mode is DVB-S2 \n");
        break;
    }
    case 2 :
    {
        S3501_PRINTF(NIM_LOG_DBG,"            work_mode is DVB-H8PSK \n");
        break;
    }
   default:
       break;
...
static void nim_s3501_print_roll_off(UINT8 roll_off)
{
    ...
    case 0 :
    {
        S3501_PRINTF(NIM_LOG_DBG,"            roll_off is 0.35\n");
        break;
    }
    case 1 :
    {
        S3501_PRINTF(NIM_LOG_DBG,"            roll_off is 0.25\n");
        break;
    }
    case 2 :
    {
        S3501_PRINTF(NIM_LOG_DBG,"            roll_off is 0.20\n");
        break;
    }
    case 3 :
    {
        S3501_PRINTF(NIM_LOG_DBG,"            roll_off is wrong\n");
        break;
    }
   default:
       break;
...
static void nim_s3501_print_map_type(UINT8 work_mode,UINT8 map_type)
{
    if(1 == work_mode)
    {
        ...
        case 0 :
        {
            S3501_PRINTF(NIM_LOG_DBG,"            map_type is HBCD\n");
            break;
        }
        case 1 :
        {
            S3501_PRINTF(NIM_LOG_DBG,"            map_type is BPSK\n");
            break;
        }
        case 2 :
        {
            S3501_PRINTF(NIM_LOG_DBG,"            map_type is QPSK\n");
            break;
        }
        case 3 :
        {
            S3501_PRINTF(NIM_LOG_DBG,"            map_type is 8PSK\n");
            break;
        }
        case 4 :
        {
            S3501_PRINTF(NIM_LOG_DBG,"            map_type is 16APSK\n");
            break;
        }
        case 5 :
        {
            S3501_PRINTF(NIM_LOG_DBG,"            map_type is 32APSK\n");
            break;
        }
        default:
            break;
...
static void nim_s3501_print_code_rate(UINT8 work_mode,UINT8 code_rate)
{
    if(0 == work_mode)
    {
        ...
        case 0 :
        {
            S3501_PRINTF(NIM_LOG_DBG,"            code_rate is 1/2\n");
            break;
        }
        case 1 :
        {
            S3501_PRINTF(NIM_LOG_DBG,"            code_rate is 2/3\n");
            break;
        }
        case 2 :
        {
            S3501_PRINTF(NIM_LOG_DBG,"            code_rate is 3/4\n");
            break;
        }
        case 3 :
        {
            S3501_PRINTF(NIM_LOG_DBG,"            code_rate is 5/6\n");
            break;
        }
        case 4 :
        {
            S3501_PRINTF(NIM_LOG_DBG,"            code_rate wrong\n");
            break;
        }
        case 5 :
        {
            S3501_PRINTF(NIM_LOG_DBG,"            code_rate is 7/8\n");
            break;
        }
        default:
            break;
    ...
    else if(1 == work_mode)
    {
        ...
        case 0 :
        {
            S3501_PRINTF(NIM_LOG_DBG,"            code_rate is 1/4\n");
            break;
        }
        case 1 :
        {
            S3501_PRINTF(NIM_LOG_DBG,"            code_rate is 1/3\n");
            break;
        }
        case 2 :
        {
            S3501_PRINTF(NIM_LOG_DBG,"            code_rate is 2/5\n");
            break;
        }
        case 3 :
        {
        ...
        case 4 :
        {
            S3501_PRINTF(NIM_LOG_DBG,"            code_rate is 3/5\n");
            break;
        }
        case 5 :
        {
        ...
        case 7 :
        {
            S3501_PRINTF(NIM_LOG_DBG,"            code_rate is 4/5\n");
            break;
        }
        case 8 :
        {
        ...
        case 9 :
        {
            S3501_PRINTF(NIM_LOG_DBG,"            code_rate is 8/9\n");
            break;
        }
        case 10 :
        {
            S3501_PRINTF(NIM_LOG_DBG,"            code_rate is 9/10\n");
            break;
        }
        default:
             break;
...
INT32 nim_s3501_set_dsp_clk (struct nim_device *dev, UINT8 clk_sel)
{
    ...
    if (priv->ul_status.m_s3501_type == NIM_CHIP_ID_M3501B)
    {
        ...
        {
            S3501_PRINTF(NIM_LOG_DBG,"Ali_NIM_Warning : M3501B need not set DSP clock\n");
        }
    }
    return SUCCESS;
}
...
#define    TDATA_SUM_LIN 6
    ...
    else
    {
        ...
        {
            S3501_PRINTF(NIM_LOG_DBG,"locked!\n");
        }
        else
        {
                              ...
                              UINT8 code_rate, UINT32 rs, UINT32 *bit_rate)
{
    ...
    if (work_mode != M3501_DVBS2_MODE) // DVBS mode
    {
        ...
        *bit_rate = data;
        S3501_PRINTF(NIM_LOG_DBG,"xxx dvbs bit_rate is %d \n", (int)(*bit_rate));
        return SUCCESS;
    }
    else    //DVBS2 mode
    {
        ...
        {
            S3501_PRINTF(NIM_LOG_DBG,"Map type error: %02x \n", map_type);
        }
        ...
        S3501_PRINTF(NIM_LOG_DBG,"Code rate is: %02x \n", code_rate);
        S3501_PRINTF(NIM_LOG_DBG,"Map type is: %02x \n", map_type);

        data += 2;
        *bit_rate = data;
        S3501_PRINTF(NIM_LOG_DBG,"xxx dvbs2 bit_rate is %d \n", (int)(*bit_rate));
        return SUCCESS;
    }
}
...
INT32 nim_s3501_waiting_channel_lock(struct nim_device *dev, UINT32 freq, UINT32 sym)
{
    ...
    S3501_PRINTF(NIM_LOG_DBG,"Enter nim_s3501_waiting_channel_lock : freq=%d, sym=%d\n", (int)freq, (int)sym);
    ...
    while (priv->ul_status.s3501_chanscan_stop_flag == 0)
    {
        ...
        if (locktimes < timeout)
        {
            ...
            S3501_PRINTF(NIM_LOG_DBG,"    timeout \n");
        ...
        if (0x3f == (intdata & 0x3f))
        {
            ...
            S3501_PRINTF(NIM_LOG_DBG,"            Freq is %d\n", (int)(LNB_LOACL_FREQ - tempfreq));

            nim_s3501_reg_get_symbol_rate(dev, &rs);
            S3501_PRINTF(NIM_LOG_DBG,"            rs is %d\n", (int)rs);
            ...
            if (priv->ul_status.m_s3501_type == NIM_CHIP_ID_M3501B)
            {
                if(1 == work_mode)
                {
                    if(priv->ul_status.m_s3501_sub_type == NIM_CHIP_SUB_ID_M3501C)
                    {
                        ...
                        if(modcod & 0x01)
                        {
                            S3501_PRINTF(NIM_LOG_DBG,"            Pilot on \n");
                        }
                        else
                        {
                            S3501_PRINTF(NIM_LOG_DBG,"            Pilot off \n");
                        }
                        modcod = modcod >> 2;
                        S3501_PRINTF(NIM_LOG_DBG,"            Modcod is %d\n", modcod);
                    }
                }
            }
            nim_s3501_reg_get_iqswap_flag(dev, &iqswap_flag);
            S3501_PRINTF(NIM_LOG_DBG,"            iqswap_flag is %d\n", iqswap_flag);
            ...
            {
                S3501_PRINTF(NIM_LOG_DBG,"            Demod Error: wrong map_type is %d\n", map_type);
            }
            else
            {
                S3501_PRINTF(NIM_LOG_DBG,"        lock chanel \n");
...
INT32 nim_s3501_i2c_close(struct nim_device *dev)
{
    ...
    if (priv->tuner_config_data.qpsk_config & M3501_I2C_THROUGH)
    {
        ...
        data = 0xc4;
        nim_reg_write(dev, RCB_I2C_CFG, &data, 1);
        S3501_PRINTF(NIM_LOG_DBG,"     @@@@Exit nim through\n");
...
INT32 nim_s3501_fft(struct nim_device *dev, UINT32 startfreq)
{
    ...
    if (dev_priv->ul_status.s3501_autoscan_stop_flag)
    {
        ...
        {
            nim_send_as_msg(dev_priv->nim_kumsgq , 0, 0, 0, 0, 0, 1);
        ...
        S3501_PRINTF(NIM_LOG_DBG,"    leave fuction nim_s3501_FFT\n");
        return SUCCESS;
    }
...
INT32 nim_change_ts_gap(struct nim_device *dev, UINT8 gap)
{
    ...
    {
        temp = 0x00;
        S3501_PRINTF(NIM_LOG_DBG,"Set ts gap 0....\n");
    }
    else if (gap == 4)
    {
        temp = 1 << 1;
        S3501_PRINTF(NIM_LOG_DBG,"Set ts gap 4....\n");
    }
    else if (gap == 8)
    {
        temp = 2 << 1;
        S3501_PRINTF(NIM_LOG_DBG,"Set ts gap 8....\n");
    }
    else if (gap == 16)
    {
        temp = 3 << 1;
        S3501_PRINTF(NIM_LOG_DBG,"Set ts gap 16....\n");
    }
    else
    {
        temp = 3 << 1;
        S3501_PRINTF(NIM_LOG_DBG,"Nim error: wrong ts gap setting....\n");
    }
...
static INT32 nim_m3501c_dvbs_ts_bps (struct nim_device *dev)
{
    ...
    if (priv->ul_status.m_s3501_type == NIM_CHIP_ID_M3501B)
    {
        if(priv->ul_status.m_s3501_sub_type == NIM_CHIP_SUB_ID_M3501C)
        {
            S3501_PRINTF(NIM_LOG_DBG,"            nim_m3501c_dvbs_ts_bps \n");
        }
    }
    return SUCCESS;
}
