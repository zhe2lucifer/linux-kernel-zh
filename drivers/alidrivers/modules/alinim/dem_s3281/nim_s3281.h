...
//#define REINIT_FLAG	//macro for reinit tuner, not define this macro default
...
#endif
#if(QAM_DEBUG)
#define S3281_PRINTF		nim_print_x
#else
...
struct  nim_s3281_private
{
	...
	tuner_command_callback nim_tuner_command;
...
#ifdef CONFIG_ARM
#define S3281_QAM1_SOC_BASE_ADDR             0x18028000
#define S3281_QAM2_SOC_BASE_ADDR             0x18030000
...
#else
#define S3281_QAM1_SOC_BASE_ADDR  			0xb8028000
#define S3281_QAM2_SOC_BASE_ADDR            0xb8030000
...
INT32 nim_s3281_dvbc_read(struct nim_device * dev,UINT16 b_mem_adr, UINT8 *p_data,UINT8 b_len);
INT32 nim_s3281_dvbc_write(struct nim_device *dev,UINT16 b_mem_adr,UINT8 *p_data,UINT8 b_len);
...
void     nim_s3281_dvbc_set_search_freq(struct nim_device * dev,UINT16 freq_range);
...
void 	nim_s3281_dvbc_set_delfreq(struct nim_device *dev,INT16 delfreq );
void    nim_s3281_task_proc(UINT32 param1, UINT32 param2);
INT32   nim_s3281_task_init(struct nim_device *dev);
extern INT32 nim_s3281_dvbc_improve_impluse_noise(struct nim_device *dev);
