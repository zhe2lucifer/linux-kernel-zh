...
INT32 nim_s3503_attach(struct QPSK_TUNER_CONFIG_API *ptrqpsk_tuner)
{
    ...
    {
        S3503_PRINTF(NIM_LOG_DBG,"Tuner Configuration API structure is NULL!/n");
        return ERR_NO_DEV;
    }
    if (nim_dev_num > NIM_DEV_NUM_2)
    {
        S3503_PRINTF(NIM_LOG_DBG,"Can not support three or more S3501 !/n");
        return ERR_NO_DEV;
    }
    ...
    if (dev == NULL)
    {
        S3503_PRINTF(NIM_LOG_DBG,"Error: Alloc nim device error!\n");
        return ERR_NO_MEM;
    }
    ...
    {
        dev_free(dev);
        S3503_PRINTF(NIM_LOG_DBG,"Alloc nim device prive memory error!/n");
        return ERR_NO_MEM;
    }
    ...
    {
        S3503_PRINTF(NIM_LOG_DBG,"Error: Register nim device error!\n");
...
static INT32 nim_s3503_open(struct nim_device *dev)
{
    ...
    S3503_PRINTF(NIM_LOG_DBG,"    Enter fuction nim_s3503_open\n");
...
#endif
    //S3503_PRINTF(NIM_LOG_DBG,"    Leave fuction nim_s3503_open\n");
    return SUCCESS;
}
...
INT32 nim_s3503_ioctl(struct nim_device *dev, INT32 cmd, UINT32 param)
{
    ...
    //S3503_PRINTF(NIM_LOG_DBG,"  Enter fuction nim_s3503_ioctl\n");
    switch (cmd)
    {
...
INT32 nim_s3503_ioctl_ext(struct nim_device *dev, INT32 cmd, void *param_list)
{
    ...
    S3503_PRINTF(NIM_LOG_DBG,"    Enter fuction nim_s3501_event_control\n");
...
#endif
        S3503_PRINTF(NIM_LOG_DBG,">>>[JIE] NIM_DRIVER_AUTO_SCAN\n");
    ...
    case NIM_DRIVER_CHANNEL_CHANGE:
        /* Do Channel Change */
        S3503_PRINTF(NIM_LOG_DBG,">>>[JIE] NIM_DRIVER_CHANNEL_CHANGE\n");
        {
...
static INT32 nim_s3503_task_init(struct nim_device *dev)
{
    ...
    {
        //S3503_PRINTF(NIM_LOG_DBG,"Task create error\n");
        return OSAL_E_FAIL;
    }
    nim_task_num++;
