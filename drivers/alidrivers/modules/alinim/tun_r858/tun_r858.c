...
R858_ErrCode r858_i2c_write(UINT32 tuner_id, I2C_TYPE *I2C_Info)
{
	...
	i2c_result = nim_i2c_write(r858_ptr->i2c_type_id, I2C_Info->I2cAddr, data, 2);
...
R858_ErrCode r858_i2c_write_len(UINT32 tuner_id, I2C_LEN_TYPE *I2C_Info)
{
	...
	{
		comm_memcpy(&data[1], &(I2C_Info->Data[len_done]), 15);
		i2c_result = nim_i2c_write(r858_ptr->i2c_type_id, I2C_Info->I2cAddr, data, 16);
		len_done += 15;
	...
	comm_memcpy(&data[1], &(I2C_Info->Data[len_done]), length-len_done);
	i2c_result = nim_i2c_write(r858_ptr->i2c_type_id, I2C_Info->I2cAddr, data, length-len_done+1);
	if(SUCCESS != i2c_result)
	{
...
R858_ErrCode r858_i2c_read_len(UINT32 tuner_id, I2C_LEN_TYPE *I2C_Info)
{
	...
	i2c_result = nim_i2c_write_read(r858_ptr->i2c_type_id, I2C_Info->I2cAddr, data, 1, length);
	if(SUCCESS != i2c_result)
	{
...
INT32 tun_r858_init(UINT32 *tuner_id, struct QAM_TUNER_CONFIG_EXT *ptrTuner_Config)
{
	...
	comm_memcpy(r858_ptr, ptrTuner_Config, sizeof(struct QAM_TUNER_CONFIG_EXT));	
...
INT32 tun_r858_command(UINT32 tuner_id, INT32 cmd, UINT32 param)
{
	...
	switch(cmd)
    {
		...
		case NIM_TUNER_GET_RF_POWER_LEVEL:
			ret = tun_r858_get_rf_level(tuner_id, (INT32 *)param);
...
INT32 tun_r858_release(void)
{
	R858_PRINTF("[%s %d]Enter!\n",__FUNCTION__,__LINE__);
    r858_tuner_cnt = 0;
    return SUCCESS;
}
