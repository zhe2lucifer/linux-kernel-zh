...
#elif defined(TMFL_OS_IS_PSOS) && defined(TMFL_CPU_IS_MIPS)
...
#elif defined(TMFL_OS_IS_PSOS) && defined(TMFL_CPU_IS_TM)
    /* TriMedia keyword is already inline */

#elif defined(TMFL_OS_IS_ECOS) && defined(TMFL_CPU_IS_MIPS)
