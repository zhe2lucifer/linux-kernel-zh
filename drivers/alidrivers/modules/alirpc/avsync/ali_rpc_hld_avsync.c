...
{ //desc of pointer para
	1, DESC_OUTPUT_STRU(0, sizeof(avsync_smoothly_play_cfg_t)), 1, DESC_P_PARA(0, 2, 0),
	//desc of pointer ret
	0,
	0,
};
...
static UINT32 desc_avsync_get_smoothly_play_cfg[] =
{ //desc of pointer para
	1, DESC_OUTPUT_STRU(0, sizeof(struct avsync_smoothly_play_cfg_t)),
	1, DESC_P_PARA(0, 2, 0),
	//desc of pointer ret
	0,
	0,
...
static UINT32 desc_avsync_pip_switch[] =
{ //desc of pointer para
	1, DESC_STATIC_STRU(0, sizeof(struct avsync_pip_param_t)),
	1, DESC_P_PARA(0, 2, 0),
	//desc of pointer ret
	0,
	0,
...
RET_CODE avsync_ioctl(struct avsync_device *dev, UINT32 io_code, UINT32 param)
{
	...
	switch(io_code)
	{
		...
		case AVSYNC_IO_GET_CURRENT_STC_RUNBACK:
			desc = desc_avsync_io_p_uint32;
			break;

        case AVSYNC_IO_PIP_SWITCH:
            desc = desc_avsync_pip_switch;
            break;
		...
		case AVSYNC_IO_SET_FASTMODE:
		case AVSYNC_IO_FLUSH:
        case AVSYNC_IO_SET_VDEC_ID:
        case AVSYNC_IO_SET_DMX_ID:
			break;
