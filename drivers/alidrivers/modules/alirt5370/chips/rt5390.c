...
/*	pAd->RfIcType = RFIC_3320; */
	...
	pChipCap->pBBPRegTable = RT5390_BBPRegTable;
	pChipCap->bbpRegTbSize = RT5390_NUM_BBP_REG_PARMS;
	...
	IN UCHAR				R66)
{
		...
		)
	{
		...
		{	/* BG band */
			...
			/*if (IS_RT30xx(pAd) ||
				 IS_RT3572(pAd)|| IS_RT3593(pAd) || IS_RT5390(pAd))*/
			{
		...
		else /* This case should not occur. Should we remove it?*/
		{	/*A band */
