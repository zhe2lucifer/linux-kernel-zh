...
/*	RECBATimerTimeout(SystemSpecific1,FunctionContext,SystemSpecific2,SystemSpecific3);*/
 ...
 && (pAd->Multi_Channel_Enable == FALSE)
	...
	*/
	...
	//+++#MTK#: BBP reset handle scheme, added by JTLee, 2014/05/22
	{
		...
		{
			DBGPRINT(RT_DEBUG_ERROR, ("Reach NO_RX_CNT_THRESHOLD !!!\n"));
...
#ifdef WSC_INCLUDED
    DBGPRINT(RT_DEBUG_INFO, ("WSC_HDR_BTN_CheckHandler WscHdrPshBtnFlag = 0x%x\n", (pAd)->WscHdrPshBtnFlag ));
