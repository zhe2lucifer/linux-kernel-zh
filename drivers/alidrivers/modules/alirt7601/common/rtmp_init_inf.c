...
int rt28xx_init(VOID *pAdSrc, PSTRING pDefaultMac, PSTRING pHostName)
{
	...
	//++#MTK#: Add flag check to avoid abnormal driver open call during driver close issue, added by JTLee, 2014/03/19 
	#if 1 
	if(RTMP_TEST_FLAG(pAd, fRTMP_ADAPTER_START_UP)) 
	{ 
		DBGPRINT(RT_DEBUG_ERROR, ("%s: Abnormal fRTMP_ADAPTER_START_UP flag set!!! Return!\n", __FUNCTION__)); 
		return FALSE; 
	} 
	#endif 
	//---#MTK#: Add flag check to avoid abnormal driver open call during driver close issue, added by JTLee, 2014/03/19
...
/*In  solution 3 of 3090F, the bPCIclkOff will be set to TRUE after calling RT28xxPciAsicRadioOff*/
        ...
        //+++#MTK#: Fix USBKickOutCmd Timeout issue, added by JTLee, 2014/02/18
		#if 1
            #ifdef MT7601
			    if ( IS_MT7601(pAd) )
