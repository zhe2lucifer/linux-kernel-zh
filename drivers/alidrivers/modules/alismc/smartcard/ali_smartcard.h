...
struct smc_device
{
    ...
    struct work_struct smc_reset_work;		//not used
    struct work_struct smc_atr_config_work;	//not used
    ...
    int b_reset_over;
    int b_atr_cfg_over;
	int get_atr_flag;//reset to get atr flag, used for parity
};
