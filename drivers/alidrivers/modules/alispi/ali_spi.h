...
#define SPI_CONTROLLER_VERSION "1.0.1"

#include <../../include/ali_soc.h>
...
#define ALI_SPI_CPU_CTRL_DMA	0x01

#define ALI_SPI_CS				0xC8
#define SPI_CS_CTRL_ENABLE		(0x3 << 25)
#define SPI_CS_ENABLE			(0x1 << 24)
#define IMB_SHARE_ENABLE		(1 << 28)

#define ALI_MEM_BIU2_REG			0x1030
...
#define ALI_SOC_BASE_ADDR			ALI_SOC_BASE
#define ALI_SOC_BASE_ADDR_SIZE		0x2000
#define C3821						0x3821
#define C3505						0x3505
#define C3503						0x3503
#define C3921						0x3921
#define C3505_QFP_PACKAGE 0xa
