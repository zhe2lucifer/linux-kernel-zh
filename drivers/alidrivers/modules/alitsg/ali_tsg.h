...
struct ali_tsg_dev
{
    ...
    */
    ...
    /* For ali_tsg_xfer_task().
	*/
	struct completion xfer_finish;
...
__s32 ali_tsg_dbg_xfer_start_cnt_inc(void);
__s32 ali_tsg_dbg_xfer_ok_cnt_inc(void);
__s32 ali_tsg_dbg_xfer_timeout_cnt_inc(void);
__s32 ali_tsg_dbg_xfer_interrupted_cnt_inc(void);

__s32 ali_tsg_dbg_usr_wr_cnt_inc(void);
__s32 ali_tsg_dbg_usr_wr_wait_cnt_inc(void);

__s32 ali_tsg_buf_wr_set(__u32 wr);
__s32 ali_tsg_buf_wr_get(void);

__s32 ali_tsg_buf_rd_set(__u32 rd);
__s32 ali_tsg_buf_rd_get(void);

__s32 ali_tsg_buf_len_set(__u32 len);
__s32 ali_tsg_buf_len_get(void);
