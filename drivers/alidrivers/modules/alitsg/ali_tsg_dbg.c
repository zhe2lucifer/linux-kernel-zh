...
static __u32 ali_tsg_dbg_xfer_start_cnt = 0;
static __u32 ali_tsg_dbg_xfer_ok_cnt = 0;
static __u32 ali_tsg_dbg_xfer_timeout_cnt = 0;
static __u32 ali_tsg_dbg_xfer_interrupted_cnt = 0;
static __u32 ali_tsg_dbg_usr_wr_cnt = 0;
static __u32 ali_tsg_dbg_usr_wr_wait_cnt = 0;
...
*
******************************************************************************/
__s32 ali_tsg_dbg_xfer_start_cnt_inc
(
    void
)
{
    ali_tsg_dbg_xfer_start_cnt++;

    return(ali_tsg_dbg_xfer_start_cnt);
}
...
*
******************************************************************************/
__s32 ali_tsg_dbg_xfer_ok_cnt_inc
(
    void
)
{
    ali_tsg_dbg_xfer_ok_cnt++;

    return(ali_tsg_dbg_xfer_ok_cnt);
}
...
*
******************************************************************************/
__s32 ali_tsg_dbg_xfer_timeout_cnt_inc
(
    void
)
{
    ali_tsg_dbg_xfer_timeout_cnt++;

    return(ali_tsg_dbg_xfer_timeout_cnt);
}
...
*
******************************************************************************/
__s32 ali_tsg_dbg_xfer_interrupted_cnt_inc
(
    void
)
{
    ali_tsg_dbg_xfer_interrupted_cnt++;

    return(ali_tsg_dbg_xfer_interrupted_cnt);
}
...
*
******************************************************************************/
__s32 ali_tsg_dbg_usr_wr_cnt_inc
(
    void
)
{
    ali_tsg_dbg_usr_wr_cnt++;

    return(ali_tsg_dbg_usr_wr_cnt);
}
...
*
******************************************************************************/
__s32 ali_tsg_dbg_usr_wr_wait_cnt_inc
(
    void
)
{
    ali_tsg_dbg_usr_wr_wait_cnt++;

    return(ali_tsg_dbg_usr_wr_wait_cnt);
}



__s32 ali_tsg_dbg_buf_wr_set
(
...
{
    //printk("%s,%d,setting:%u,setting:%u\n", __FUNCTION__, __LINE__,
		//(__u32)setting);

    ali_tsg_buf_wr_set((__u32)setting);
...
{
    *val = ali_tsg_buf_wr_get();

    return 0;
}

DEFINE_SIMPLE_ATTRIBUTE(ali_tsg_dbg_buf_wr_fops, 
	ali_tsg_dbg_buf_wr_get, ali_tsg_dbg_buf_wr_set, "%llu\n");



__s32 ali_tsg_dbg_buf_rd_set
(
    /* Passed in by debugfs_create_file().
    */
    void *show_cnt_ptr, 
...
)
{
    ...
    ali_tsg_buf_rd_set((__u32)setting);
...
{
    *val = ali_tsg_buf_rd_get();

    return 0;
}

DEFINE_SIMPLE_ATTRIBUTE(ali_tsg_dbg_buf_rd_fops, 
	ali_tsg_dbg_buf_rd_get, ali_tsg_dbg_buf_rd_set, "%llu\n");



__s32 ali_tsg_dbg_buf_len_set
(
    /* Passed in by debugfs_create_file().
    */
    void *show_cnt_ptr, 
...
)
{
    ...
    ali_tsg_buf_len_set((__u32)setting);
...
{
    *val = ali_tsg_buf_len_get();

    return 0;
}

DEFINE_SIMPLE_ATTRIBUTE(ali_tsg_dbg_buf_len_fops, 
	ali_tsg_dbg_buf_len_get, ali_tsg_dbg_buf_len_set, "%llu\n");
...
)
{
	...
	*/
    ...
    fs_entry = debugfs_create_u32("xfer_irq_cnt", 0644,
    ...
    fs_entry = debugfs_create_u32("xfer_syncerr_irq_cnt", 0644, 
    ...
    fs_entry = debugfs_create_u32("xfer_start_cnt", 0644, 
                                  ali_tsg_dbg_debugfs_root,
                                  &ali_tsg_dbg_xfer_start_cnt);
    if (!fs_entry)
    {
    ...
    fs_entry = debugfs_create_u32("xfer_ok_cnt", 0644, 
                                  ali_tsg_dbg_debugfs_root,
                                  &ali_tsg_dbg_xfer_ok_cnt);
    if (!fs_entry)
    {
    ...
    fs_entry = debugfs_create_u32("xfer_timeout_cnt", 0644, 
                                  ali_tsg_dbg_debugfs_root,
                                  &ali_tsg_dbg_xfer_timeout_cnt);
    if (!fs_entry)
    {
    ...
    fs_entry = debugfs_create_u32("xfer_interrupted_cnt", 0644, 
                                  ali_tsg_dbg_debugfs_root,
                                  &ali_tsg_dbg_xfer_interrupted_cnt);
    if (!fs_entry)
    {
    ...
    fs_entry = debugfs_create_u32("usr_wr_cnt", 0644, 
                                  ali_tsg_dbg_debugfs_root,
                                  &ali_tsg_dbg_usr_wr_cnt);
    if (!fs_entry)
    {
    ...
    fs_entry = debugfs_create_u32("usr_wr_wait_cnt", 0644, 
                                  ali_tsg_dbg_debugfs_root,
                                  &ali_tsg_dbg_usr_wr_wait_cnt);
    if (!fs_entry)
    {
    ...
    fs_entry = debugfs_create_file("buf_wr", 0644,
	    ali_tsg_dbg_debugfs_root, NULL, &ali_tsg_dbg_buf_wr_fops);
    ...
    fs_entry = debugfs_create_file("buf_rd", 0644,
	    ali_tsg_dbg_debugfs_root, NULL, &ali_tsg_dbg_buf_rd_fops);
    ...
    fs_entry = debugfs_create_file("buf_len", 0644,
	    ali_tsg_dbg_debugfs_root, NULL, &ali_tsg_dbg_buf_len_fops);
