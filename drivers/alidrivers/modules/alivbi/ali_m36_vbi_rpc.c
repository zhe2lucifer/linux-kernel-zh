 ...
 #endif
{
	...
	if((cmd & VBI_CALL) == 0)
	{
		if((cmd == IO_VBI_ENGINE_UPDATE_INIT_PAGE) ||(cmd == IO_VBI_ENGINE_UPDATE_SUBT_PAGE))	
		{
			...
			copy_from_user((void *)&param, (void *)parg, 3);
		...
		#if 0
		{
			...
			//copy_from_user((void *)(__G_ALI_MM_TTX_PARAM_BUF_ADDR + 4), (void *)parg, 3);
			copy_from_user((void *)lang, (void *)parg, 3);
			...
			//ret = vbi_ioctl(p_vbi_dev, cmd, (__G_ALI_MM_TTX_PARAM_BUF_ADDR));
			ret = vbi_ioctl(p_vbi_dev, cmd, (UINT32)lang);
	...
	else
	{
		switch(cmd)
		{
			case CALL_VBI_SETOUTPUT:
				copy_from_user((void*)(&tbuf), (void*)arg, sizeof(t_vbirequest)); /*by tony*/
				vbi_setoutput(p_vbi_dev, (t_vbirequest *)&tbuf);
				copy_to_user((void*)arg, (void*)(&tbuf), sizeof(t_vbirequest));
				break;
...
MODULE_DESCRIPTION("ALI m36 vbi rpc");
MODULE_LICENSE("GPL");
