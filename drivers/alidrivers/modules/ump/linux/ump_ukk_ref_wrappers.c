...
int ump_map_phy_wrapper(u32 __user * argument, struct ump_session_data  * session_data) 
{
	...
	user_interaction.ump_handle= (u32)hMem;
	...
	/*DBG_MSG(1, ("<ALi_KER_DEBUG> success, mem handle = %x, secure_id = %d\n",(u32)((_ump_uk_map_phy_s *)argument)->ump_handle, (u32)((_ump_uk_map_phy_s *)argument)->secure_id));*/
	DBG_MSG(1, ("<ALi_KER_DEBUG> success, mem handle = %u, secure_id = %u\n", user_interaction.ump_handle, user_interaction.secure_id));
	return 0; /* success */
