...
#define SPINAND_CMD_PROG_PAGE_CLRCACHE_X4      0x32
...
#define QE_ENABLE		0x01
#define QE_DISABLE		0x0
...
struct spi_nand_chip {
       ...
       int (*enable_qe)(struct spi_nand_chip *chip);
       int (*disable_qe)(struct spi_nand_chip *chip);
